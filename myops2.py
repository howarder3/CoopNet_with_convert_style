...
def uk(inputs, k, reuse=False, norm='instance', is_training=True, name=None, output_size=None):
  ...
  with tf.variable_scope(name, reuse=reuse):
    ...
    # print('input_shape.shape = {}'.format(input_shape.shape))
    ...
    fsconv = tf.nn.conv2d_transpose(inputs, weights,
