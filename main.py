...
tf.flags.DEFINE_string('category2', 'alp', 'The name of dataset')
...
def main(_):
    ...
    model = CoopNets(
        ...
        log_step=FLAGS.log_step, data_path=FLAGS.data_dir, category=FLAGS.category, category2=FLAGS.category2,
